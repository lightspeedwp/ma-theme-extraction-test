...
- The scaffold repositories use mustache template variables (e.g., `{{slug}}`, `1.0.0`) which must be replaced by the generator before the packages can be fully tested
