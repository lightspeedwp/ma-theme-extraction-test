<?php
/**
 * Title: Card CPD Activity
 * Slug: ma-theme/card-cpd-activity
 * Categories: cards, featured
 * Keywords: card, cpd, activity
 * Post Types: page, post
 * Inserter: yes
 * Description: A card component for CPD activities with image, duration, Points badge, and call to action.
 *
 * @package WordPress
 * @subpackage Medical_Academic_Theme
 * @since Medical Academic Theme 1.0.0
 */
...
<div class="wp-block-group is-style-cpd-card">
	...
	<div class="wp-block-cover is-position-bottom-right" style="padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10);min-height:200px;border-top-left-radius:var(--wp--preset--radius--medium);border-top-right-radius:var(--wp--preset--radius--medium)">
		...
		<img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/bec715fa5f1c8401fd1e0ab078ef3f0c658d2434.png" data-object-fit="cover"/>
		<div class="wp-block-cover__inner-container">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group has-cta-core-background-color has-background" style="border-radius:var(--wp--preset--radius--small);padding-top:3px;padding-right:12px;padding-bottom:3px;padding-left:12px">
					...
					<p class="has-base-color has-text-color has-100-font-size"><?php esc_html_e( '2 points', 'ma-theme' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
	...
	<div class="wp-block-group is-style-cpd-card-content">
		...
		<div class="wp-block-group">
			...
			<h6 class="wp-block-heading has-brand-core-color has-text-color has-200-font-size"><a href="#"><?php esc_html_e( 'Cardiology', 'ma-theme' ); ?></a></h6>
			<!-- /wp:heading -->

			<!-- wp:heading {"metadata":{"name":"Title"},"level":5,"textColor":"contrast","fontSize":"300"} -->
			<h5 class="wp-block-heading has-contrast-color has-text-color has-300-font-size"><?php esc_html_e( 'Hypertension Management Guidelines', 'ma-theme' ); ?></h5>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			...
			<p class="has-neutral-700-color has-text-color has-200-font-size"><?php esc_html_e( '1h', 'ma-theme' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-cta-outline"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'View CPD activity', 'ma-theme' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
